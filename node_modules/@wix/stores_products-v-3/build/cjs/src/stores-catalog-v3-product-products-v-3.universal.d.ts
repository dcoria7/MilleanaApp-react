...
export interface BulkAdjustVariantsByFilterRequest {
...
export interface BulkAdjustVariantsByFilterResponse {
    /**
     * Job ID.
     *
     * Pass this ID to [Get Async Job](https://dev.wix.com/docs/rest/business-management/async-job/introduction) to retrieve job details and metadata..
...
export interface BulkAdjustProductVariantsByFilterResponseNonNullableFields {
    jobId: string;
}
 ...
 * @applicableIdentity APP
 */
export declare function bulkAdjustProductVariantsByFilter(filter: Record<string, any> | null, options?: BulkAdjustProductVariantsByFilterOptions): Promise<BulkAdjustProductVariantsByFilterResponse & BulkAdjustProductVariantsByFilterResponseNonNullableFields>;
