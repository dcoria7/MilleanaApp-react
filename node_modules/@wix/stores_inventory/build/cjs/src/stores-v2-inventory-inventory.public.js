...
const stores_v2_inventory_inventory_universal_1 = require("./stores-v2-inventory-inventory.universal");
exports.__metadata = { PACKAGE_NAME: '@wix/stores' };
function getInventoryVariants(httpClient) {
    return (inventoryId, options) => (0, stores_v2_inventory_inventory_universal_1.getInventoryVariants)(inventoryId, options, 
    // @ts-ignore
    { httpClient });
}
exports.getInventoryVariants = getInventoryVariants;
function queryInventory(httpClient) {
    return (options) => (0, stores_v2_inventory_inventory_universal_1.queryInventory)(options, 
    // @ts-ignore
    { httpClient });
}
exports.queryInventory = queryInventory;
function updateInventoryVariants(httpClient) {
    return (productId, inventoryItem) => (0, stores_v2_inventory_inventory_universal_1.updateInventoryVariants)(productId, inventoryItem, 
    // @ts-ignore
    { httpClient });
}
exports.updateInventoryVariants = updateInventoryVariants;
function decrementInventory(httpClient) {
    return (decrementData) => (0, stores_v2_inventory_inventory_universal_1.decrementInventory)(decrementData, 
    // @ts-ignore
    { httpClient });
}
exports.decrementInventory = decrementInventory;
function incrementInventory(httpClient) {
    return (incrementData) => (0, stores_v2_inventory_inventory_universal_1.incrementInventory)(incrementData, 
    // @ts-ignore
    { httpClient });
}
...
var stores_v2_inventory_inventory_universal_2 = require("./stores-v2-inventory-inventory.universal");
Object.defineProperty(exports, "ReasonType", { enumerable: true, get: function () { return stores_v2_inventory_inventory_universal_2.ReasonType; } });
Object.defineProperty(exports, "WebhookIdentityType", { enumerable: true, get: function () { return stores_v2_inventory_inventory_universal_2.WebhookIdentityType; } });
