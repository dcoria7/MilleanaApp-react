import * as ambassadorWixStoresV2InventoryTypes from './stores-v2-inventory-inventory.types';
import * as ambassadorWixStoresV2InventoryUniversalTypes from './stores-v2-inventory-inventory.universal';
