 ...
 */
declare function createRibbon(ribbon: Ribbon): Promise<Ribbon & RibbonNonNullableFields>;
/**
 * Retrieves a ribbon.
 ...
 * @returns Ribbon.
 */
declare function getRibbon(ribbonId: string, options?: GetRibbonOptions): Promise<Ribbon & RibbonNonNullableFields>;
 ...
 */
declare function updateRibbon(_id: string | null, ribbon: UpdateRibbon, options?: UpdateRibbonOptions): Promise<Ribbon & RibbonNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkCreateRibbons(ribbons: Ribbon[], options?: BulkCreateRibbonsOptions): Promise<BulkCreateRibbonsResponse & BulkCreateRibbonsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateRibbons(ribbons: MaskedRibbon[], options?: BulkUpdateRibbonsOptions): Promise<BulkUpdateRibbonsResponse & BulkUpdateRibbonsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function getOrCreateRibbon(ribbonName: string, options?: GetOrCreateRibbonOptions): Promise<GetOrCreateRibbonResponse & GetOrCreateRibbonResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkGetOrCreateRibbons(ribbonNames: string[], options?: BulkGetOrCreateRibbonsOptions): Promise<BulkGetOrCreateRibbonsResponse & BulkGetOrCreateRibbonsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkDeleteRibbons(ribbonIds: string[]): Promise<BulkDeleteRibbonsResponse & BulkDeleteRibbonsResponseNonNullableFields>;

export { type ActionEvent, type App, type ApplicationError, type BaseEventMetadata, type BulkActionMetadata, type BulkCreateRibbonsOptions, type BulkCreateRibbonsRequest, type BulkCreateRibbonsResponse, type BulkCreateRibbonsResponseNonNullableFields, type BulkDeleteRibbonsRequest, type BulkDeleteRibbonsResponse, type BulkDeleteRibbonsResponseNonNullableFields, type BulkGetOrCreateRibbonsOptions, type BulkGetOrCreateRibbonsRequest, type BulkGetOrCreateRibbonsResponse, type BulkGetOrCreateRibbonsResponseNonNullableFields, type BulkRibbonResult, type BulkUpdateRibbonsOptions, type BulkUpdateRibbonsRequest, type BulkUpdateRibbonsResponse, type BulkUpdateRibbonsResponseNonNullableFields, type CreateRibbonRequest, type CreateRibbonResponse, type CreateRibbonResponseNonNullableFields, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DeleteRibbonRequest, type DeleteRibbonResponse, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type File, type GetOrCreateRibbonOptions, type GetOrCreateRibbonRequest, type GetOrCreateRibbonResponse, type GetOrCreateRibbonResponseNonNullableFields, type GetRibbonOptions, type GetRibbonRequest, type GetRibbonResponse, type GetRibbonResponseNonNullableFields, type IdentificationData, type IdentificationDataIdOneOf, type InvalidateCache, type InvalidateCacheGetByOneOf, type ItemMetadata, type MaskedRibbon, type MessageEnvelope, type Page, type QueryRibbonsOptions, type QueryRibbonsRequest, type QueryRibbonsResponse, type QueryRibbonsResponseNonNullableFields, RequestedFields, type RestoreInfo, type Ribbon, type RibbonCreatedEnvelope, type RibbonDeletedEnvelope, type RibbonNonNullableFields, type RibbonUpdatedEnvelope, type RibbonsQueryBuilder, type RibbonsQueryResult, SortOrder, type Sorting, type URI, type UpdateRibbon, type UpdateRibbonOptions, type UpdateRibbonRequest, type UpdateRibbonResponse, type UpdateRibbonResponseNonNullableFields, type V3BulkRibbonResult, WebhookIdentityType, bulkCreateRibbons, bulkDeleteRibbons, bulkGetOrCreateRibbons, bulkUpdateRibbons, createRibbon, deleteRibbon, getOrCreateRibbon, getRibbon, onRibbonCreated, onRibbonDeleted, onRibbonUpdated, queryRibbons, updateRibbon };
