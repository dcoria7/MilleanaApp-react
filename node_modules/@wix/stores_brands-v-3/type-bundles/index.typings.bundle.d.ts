 ...
 */
declare function createBrand(brand: Brand): Promise<Brand & BrandNonNullableFields>;
/**
 * Retrieves a brand.
 ...
 * @returns Brand.
 */
declare function getBrand(brandId: string, options?: GetBrandOptions): Promise<Brand & BrandNonNullableFields>;
 ...
 */
declare function updateBrand(_id: string | null, brand: UpdateBrand, options?: UpdateBrandOptions): Promise<Brand & BrandNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkCreateBrands(brands: Brand[], options?: BulkCreateBrandsOptions): Promise<BulkCreateBrandsResponse & BulkCreateBrandsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateBrands(brands: MaskedBrand[], options?: BulkUpdateBrandsOptions): Promise<BulkUpdateBrandsResponse & BulkUpdateBrandsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function getOrCreateBrand(brandName: string, options?: GetOrCreateBrandOptions): Promise<GetOrCreateBrandResponse & GetOrCreateBrandResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkGetOrCreateBrands(brandNames: string[], options?: BulkGetOrCreateBrandsOptions): Promise<BulkGetOrCreateBrandsResponse & BulkGetOrCreateBrandsResponseNonNullableFields>;
