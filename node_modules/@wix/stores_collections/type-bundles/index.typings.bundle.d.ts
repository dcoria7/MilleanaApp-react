 ...
 * @requiredField _id
 */
declare function getCollection(_id: string): Promise<Collection & CollectionNonNullableFields>;
/**
...
export { type Collection, type CollectionNonNullableFields, type CollectionsQueryBuilder, type CollectionsQueryResult, type CursorPaging, type Cursors, type GetCollectionBySlugRequest, type GetCollectionBySlugResponse, type GetCollectionBySlugResponseNonNullableFields, type GetCollectionRequest, type GetCollectionResponse, type GetCollectionResponseNonNullableFields, type Keyword, type Media, type MediaItem, type MediaItemItemOneOf, MediaItemType, type MediaItemUrlAndSize, type MediaItemVideo, type PlatformPaging, type PlatformPagingMetadata, type PlatformQuery, type PlatformQueryPagingMethodOneOf, type QueryCollectionsRequest, type QueryCollectionsResponse, type QueryCollectionsResponseNonNullableFields, type SeoSchema, type Settings, SortOrder, type Sorting, type Tag, getCollection, getCollectionBySlug, queryCollections };
