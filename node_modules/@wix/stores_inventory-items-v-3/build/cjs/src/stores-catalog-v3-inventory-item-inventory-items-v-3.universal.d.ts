...
export interface InventoryQuery extends InventoryQueryPagingMethodOneOf {
...
/** @oneof */
export interface InventoryQueryPagingMethodOneOf {
    /** Pointer to page of results using offset. Cannot be used together with `cursorPaging`. */
    paging?: InventoryPaging;
    /** Cursor pointing to page of results. Cannot be used together with `paging`. `cursorPaging.cursor` can not be used together with `filter` or `sort`. */
    cursorPaging?: InventoryCursorPaging;
...
export interface InventoryCursorPaging {
    /**
     * Number of items to load.
...
export interface BulkSetInventoryItemsForProductsInLocationRequest {
...
export interface ProductInventoryItems {
...
export interface BulkSetInventoryItemsForProductsInLocationResponse {
