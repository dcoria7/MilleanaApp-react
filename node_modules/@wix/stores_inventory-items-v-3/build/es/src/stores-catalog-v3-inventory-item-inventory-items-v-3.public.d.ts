...
export { ActionEvent, AdjustInventoryAction, AdjustInventoryActionActionOneOf, Aggregation, AggregationData, AggregationKindOneOf, AggregationResults, AggregationResultsResultOneOf, AggregationResultsScalarResult, AggregationType, App, ApplicationError, AvailabilityStatus, BaseEventMetadata, BulkActionMetadata, BulkCreateInventoryItemsOptions, BulkCreateInventoryItemsRequest, BulkCreateInventoryItemsResponse, BulkCreateInventoryItemsResponseNonNullableFields, BulkDecrementInventoryItemsByVariantAndLocationOptions, BulkDecrementInventoryItemsByVariantAndLocationRequest, BulkDecrementInventoryItemsByVariantAndLocationResponse, BulkDecrementInventoryItemsByVariantAndLocationResponseNonNullableFields, BulkDecrementInventoryItemsOptions, BulkDecrementInventoryItemsRequest, BulkDecrementInventoryItemsResponse, BulkDecrementInventoryItemsResponseNonNullableFields, BulkDeleteInventoryItemsRequest, BulkDeleteInventoryItemsResponse, BulkDeleteInventoryItemsResponseNonNullableFields, BulkIncrementInventoryItemsByVariantAndLocationOptions, BulkIncrementInventoryItemsByVariantAndLocationRequest, BulkIncrementInventoryItemsByVariantAndLocationResponse, BulkIncrementInventoryItemsByVariantAndLocationResponseNonNullableFields, BulkIncrementInventoryItemsOptions, BulkIncrementInventoryItemsRequest, BulkIncrementInventoryItemsResponse, BulkIncrementInventoryItemsResponseNonNullableFields, BulkInventoryItemAction, BulkInventoryItemResult, BulkSetInventoryItemsForProductsInLocationRequest, BulkSetInventoryItemsForProductsInLocationResponse, BulkSetOrAdjustInventoryItemsByFilterRequest, BulkSetOrAdjustInventoryItemsByFilterResponse, BulkUpdateInventoryItemsByFilterOptions, BulkUpdateInventoryItemsByFilterRequest, BulkUpdateInventoryItemsByFilterResponse, BulkUpdateInventoryItemsByFilterResponseNonNullableFields, BulkUpdateInventoryItemsOptions, BulkUpdateInventoryItemsRequest, BulkUpdateInventoryItemsResponse, BulkUpdateInventoryItemsResponseNonNullableFields, CreateInventoryItemRequest, CreateInventoryItemResponse, CreateInventoryItemResponseNonNullableFields, CursorPaging, CursorPagingMetadata, CursorSearch, CursorSearchPagingMethodOneOf, Cursors, DateHistogramAggregation, DateHistogramResult, DateHistogramResults, DecrementDataById, DecrementDataByVariantAndLocation, DeleteInventoryItemRequest, DeleteInventoryItemResponse, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, EventMetadata, ExtendedFields, File, GetInventoryItemRequest, GetInventoryItemResponse, GetInventoryItemResponseNonNullableFields, GroupByAggregation, GroupByAggregationKindOneOf, GroupByValueResults, IdentificationData, IdentificationDataIdOneOf, IncludeMissingValuesOptions, IncrementDataById, IncrementDataByVariantAndLocation, Interval, InvalidateCache, InvalidateCacheGetByOneOf, InventoryCursorPaging, InventoryItem, InventoryItemCreatedEnvelope, InventoryItemDeletedEnvelope, InventoryItemNonNullableFields, InventoryItemStockStatusUpdatedEnvelope, InventoryItemStockStatusUpdatedEvent, InventoryItemTrackingMethodOneOf, InventoryItemUpdatedEnvelope, InventoryItemUpdatedWithReason, InventoryItemUpdatedWithReasonEnvelope, InventoryItemsQueryBuilder, InventoryItemsQueryResult, InventoryPaging, InventoryQuery, InventoryQueryPagingMethodOneOf, ItemMetadata, MaskedInventoryItem, MessageEnvelope, MissingValues, Mode, NestedAggregation, NestedAggregationItem, NestedAggregationItemKindOneOf, NestedAggregationResults, NestedAggregationResultsResultOneOf, NestedAggregationType, NestedResultValue, NestedResultValueResultOneOf, NestedResults, NestedValueAggregationResult, Page, PagingMetadata, PlatformOffsetSearch, PlatformOffsetSearchPagingMethodOneOf, PlatformPaging, PlatformPagingMetadataV2, PreorderInfo, Product, ProductInventoryItems, QueryInventoryItemsRequest, QueryInventoryItemsResponse, QueryInventoryItemsResponseNonNullableFields, RangeAggregation, RangeAggregationResult, RangeBucket, RangeResult, RangeResults, ReasonType, RestoreInfo, Results, ScalarAggregation, ScalarResult, ScalarType, SearchDetails, SearchInventoryItemsOptions, SearchInventoryItemsRequest, SearchInventoryItemsResponse, SearchInventoryItemsResponseNonNullableFields, SearchInventoryItemsWithOffsetRequest, SearchInventoryItemsWithOffsetResponse, SortDirection, SortOrder, SortType, Sorting, URI, UpdateInventoryItem, UpdateInventoryItemOptions, UpdateInventoryItemRequest, UpdateInventoryItemResponse, UpdateInventoryItemResponseNonNullableFields, V3BulkInventoryItemResult, ValueAggregation, ValueAggregationOptionsOneOf, ValueAggregationResult, ValueResult, ValueResults, WebhookIdentityType, } from './stores-catalog-v3-inventory-item-inventory-items-v-3.universal';
