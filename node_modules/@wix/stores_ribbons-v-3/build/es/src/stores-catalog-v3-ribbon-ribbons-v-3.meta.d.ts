import * as ambassadorWixStoresCatalogV3RibbonTypes from './stores-catalog-v3-ribbon-ribbons-v-3.types';
import * as ambassadorWixStoresCatalogV3RibbonUniversalTypes from './stores-catalog-v3-ribbon-ribbons-v-3.universal';
