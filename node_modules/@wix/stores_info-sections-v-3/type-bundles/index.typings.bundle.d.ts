 ...
 */
declare function createInfoSection(infoSection: InfoSection): Promise<InfoSection & InfoSectionNonNullableFields>;
/**
 ...
 */
declare function getInfoSection(infoSectionId: string, options?: GetInfoSectionOptions): Promise<InfoSection & InfoSectionNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function getOrCreateInfoSection(options?: GetOrCreateInfoSectionOptions): Promise<GetOrCreateInfoSectionResponse & GetOrCreateInfoSectionResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkGetOrCreateInfoSections(options?: BulkGetOrCreateInfoSectionsOptions): Promise<BulkGetOrCreateInfoSectionsResponse & BulkGetOrCreateInfoSectionsResponseNonNullableFields>;
 ...
 */
declare function updateInfoSection(_id: string | null, infoSection: UpdateInfoSection, options?: UpdateInfoSectionOptions): Promise<InfoSection & InfoSectionNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkCreateInfoSections(infoSections: InfoSection[], options?: BulkCreateInfoSectionsOptions): Promise<BulkCreateInfoSectionsResponse & BulkCreateInfoSectionsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateInfoSections(infoSections: MaskedInfoSection[], options?: BulkUpdateInfoSectionsOptions): Promise<BulkUpdateInfoSectionsResponse & BulkUpdateInfoSectionsResponseNonNullableFields>;
