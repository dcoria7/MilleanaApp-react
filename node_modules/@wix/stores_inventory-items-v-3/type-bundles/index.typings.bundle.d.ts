 ...
 */
declare function createInventoryItem(inventoryItem: InventoryItem): Promise<InventoryItem & InventoryItemNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function bulkCreateInventoryItems(inventoryItems: InventoryItem[], options?: BulkCreateInventoryItemsOptions): Promise<BulkCreateInventoryItemsResponse & BulkCreateInventoryItemsResponseNonNullableFields>;
 ...
 */
declare function getInventoryItem(inventoryItemId: string): Promise<InventoryItem & InventoryItemNonNullableFields>;
/**
 ...
 */
declare function updateInventoryItem(_id: string | null, inventoryItem: UpdateInventoryItem, options?: UpdateInventoryItemOptions): Promise<InventoryItem & InventoryItemNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateInventoryItems(inventoryItems: MaskedInventoryItem[], options?: BulkUpdateInventoryItemsOptions): Promise<BulkUpdateInventoryItemsResponse & BulkUpdateInventoryItemsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateInventoryItemsByFilter(filter: Record<string, any> | null, options?: BulkUpdateInventoryItemsByFilterOptions): Promise<BulkUpdateInventoryItemsByFilterResponse & BulkUpdateInventoryItemsByFilterResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkDeleteInventoryItems(inventoryItemIds: string[]): Promise<BulkDeleteInventoryItemsResponse & BulkDeleteInventoryItemsResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity VISITOR
 */
declare function searchInventoryItems(options?: SearchInventoryItemsOptions): Promise<SearchInventoryItemsResponse & SearchInventoryItemsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkDecrementInventoryItems(decrementData: DecrementDataById[], options?: BulkDecrementInventoryItemsOptions): Promise<BulkDecrementInventoryItemsResponse & BulkDecrementInventoryItemsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkIncrementInventoryItems(incrementData: IncrementDataById[], options?: BulkIncrementInventoryItemsOptions): Promise<BulkIncrementInventoryItemsResponse & BulkIncrementInventoryItemsResponseNonNullableFields>;
